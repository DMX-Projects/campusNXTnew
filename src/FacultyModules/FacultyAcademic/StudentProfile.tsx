...
const StudentProfile: React.FC = () => {
  ...
  const handleDownloadProfileData = () => {
    // For demonstration, just alert. Replace with actual download logic if needed.
    alert('Downloading profile data...');
  };

  const handleDeactivateAccount = () => {
    // For demonstration, just alert. Replace with actual deactivation logic if needed.
            ...
            <div className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex gap-4">
                  <button onClick={() => handleDownloadProfileData()} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg">
                    Download Profile Data
                  </button>
                  <button onClick={() => handleDeactivateAccount()} className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg">
                    Deactivate Account
                  </button>
                </div>
              </div>
