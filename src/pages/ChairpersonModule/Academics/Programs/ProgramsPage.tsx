...
// If 'Program' is exported from a different file, update the import path accordingly.
// For example, if it's exported from '../../../../types/Program', use:
// Update the import path below to the correct location of Program type.
// For example, if Program is exported from '../../../../types/Program', use:
import { Program } from '../../../../types/Program';
// Or, if Program is exported from '../../../../types/index.ts', use:
// import { Program } from '../../../../types';
// Or, if it should be exported from 'index.ts', add the following line to '../../../../types/index.ts':
