...
const HostelAdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 transition-colors duration-200">
      {/* Header */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 mb-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Hostel Administration Dashboard</h1>
            <p className="text-gray-600 dark:text-gray-400 text-sm">Comprehensive hostel management overview</p>
          </div>
      ...
      {/* Search and Filters */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 mb-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
        <div className="flex flex-col md:flex-row gap-3 items-center justify-between">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors duration-200"
              value={searchTerm}
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors duration-200"
            >
            ...
            <button 
              ...
              className="px-3 py-2 bg-blue-600 dark:bg-blue-600 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-700 flex items-center gap-2 text-sm transition-colors duration-200"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Daily Entry/Exit</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            ...
            <span className="text-red-500 dark:text-red-400">18 violations</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Student Locations</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Block Occupancy</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            <span>Avg: 91.9%</span>
            <span className="text-green-600 dark:text-green-400">1247/1360 beds</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Room Revenue</h3>
            <div className="text-xs text-green-500 dark:text-green-400">₹22.2L/month</div>
          </div>
          <ResponsiveContainer width="100%" height={160}>
            <BarChart data={roomTypes} layout="horizontal">
              <XAxis type="number" tick={{ fontSize: 10 }} />
              <YAxis dataKey="type" type="category" tick={{ fontSize: 8 }} width={60} />
              <Tooltip formatter={(value) => `₹${(value/1000).toFixed(0)}K`} contentStyle={{ backgroundColor: 'rgb(31 41 55)', border: 'none', borderRadius: '8px' }} />
              <Bar dataKey="revenue" fill="#10B981" />
            </BarChart>
          </ResponsiveContainer>
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            <span>407/425 occupied</span>
            <span className="text-green-600 dark:text-green-400">95.8% utilization</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Support Tickets</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            <span>Open: 27</span>
            <span className="text-green-600 dark:text-green-400">Resolved: 63</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Permission Trends</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            ...
            <span className="text-blue-600 dark:text-blue-400">Gate Pass: 234</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Inventory Status</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            <span className="text-red-500 dark:text-red-400">Low: 2 items</span>
            <span className="text-green-600 dark:text-green-400">94% Available</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Mess Utilization</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            ...
            <span className="text-green-600 dark:text-green-400">Rating: 4.3⭐</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Staff Attendance</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            ...
            <span className="text-green-600 dark:text-green-400">94.4% attendance</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Security Monitoring</h3>
          ...
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-2">
            ...
            <span className="text-yellow-600 dark:text-yellow-400">234 late entries</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Utility Usage</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Fee Collection</h3>
            <div className="text-xs text-green-500 dark:text-green-400">87.3% paid</div>
          </div>
          <ResponsiveContainer width="100%" height={160}>
            <PieChart>
              <Pie
          ...
          <div className="grid grid-cols-1 gap-1 text-xs text-gray-600 dark:text-gray-400">
            <span className="flex justify-between">
              <span>Overdue:</span>
              <span className="text-red-600 dark:text-red-400">₹6.3L</span>
            </span>
            <span className="flex justify-between">
              <span>Pending:</span>
              <span className="text-yellow-600 dark:text-yellow-400">₹26.8L</span>
            </span>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 mb-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Monthly Revenue Trends</h3>
          <div className="text-sm text-green-600 dark:text-green-400">Current: ₹34.3L</div>
        </div>
        <ResponsiveContainer width="100%" height={200}>
          <ComposedChart data={revenueTrends}>
            ...
            <XAxis dataKey="month" />
            <YAxis />
            <Tooltip formatter={(value) => `₹${(value/100000).toFixed(1)}L`} contentStyle={{ backgroundColor: 'rgb(31 41 55)', border: 'none', borderRadius: '8px' }} />
        ...
        <div className="flex justify-center gap-6 text-xs text-gray-600 dark:text-gray-400 mt-2">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
        <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">Today's Key Metrics</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            <div className="text-xl font-bold text-blue-600 dark:text-blue-400">1,247</div>
            <div className="text-xs text-gray-600 dark:text-gray-400">Students Present</div>
          </div>
          <div className="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
            <div className="text-xl font-bold text-green-600 dark:text-green-400">91.9%</div>
            <div className="text-xs text-gray-600 dark:text-gray-400">Occupancy Rate</div>
          </div>
          <div className="text-center p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
            <div className="text-xl font-bold text-orange-600 dark:text-orange-400">27</div>
            <div className="text-xs text-gray-600 dark:text-gray-400">Open Tickets</div>
          </div>
          <div className="text-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
            <div className="text-xl font-bold text-purple-600 dark:text-purple-400">48</div>
          ...
          <div className="text-center p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
            <div className="text-xl font-bold text-indigo-600 dark:text-indigo-400">1,143</div>
            <div className="text-xs text-gray-600 dark:text-gray-400">Mess Attendance</div>
          </div>
          <div className="text-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
            <div className="text-xl font-bold text-yellow-600 dark:text-yellow-400">68/72</div>
            <div className="text-xs text-gray-600 dark:text-gray-400">Staff Present</div>
          </div>
          <div className="text-center p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg border border-teal-200 dark:border-teal-800">
            <div className="text-xl font-bold text-teal-600 dark:text-teal-400">398</div>
            <div className="text-xs text-gray-600 dark:text-gray-400">Month Permissions</div>
          </div>
        </div>
      </div>
    </div>
