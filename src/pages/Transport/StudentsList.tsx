          ...
          <table className="w-full">
            <thead className="border-b border-gray-200">
              <tr>
                ...
                <th className="text-left py-3 px-4 font-medium text-gray-700">Fee Status</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredStudents.map((student) => (
                <tr key={student.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-4 px-4 text-gray-800">{student.class} - {student.section}</td>
                  <td className="py-4 px-4 text-gray-800">{student.busRoute}</td>
                  <td className="py-4 px-4">
                  ...
                  <td className="py-4 px-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${feeStatusColors[student.feeStatus]}`}>
                      {student.feeStatus}
                    </span>
                  </td>
                  <td className="py-4 px-4">
