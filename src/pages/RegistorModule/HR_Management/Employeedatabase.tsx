      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <div className={`${isDark ? 'bg-gray-800 text-white' : 'bg-white'} rounded-lg p-6 w-full max-w-lg`}>
          <div className="flex justify-between mb-6">
            ...
            <button onClick={onClose} className={`p-2 rounded-full hover:bg-gray-100 ${isDark ? 'dark:hover:bg-gray-700' : ''}`}>
              <X className="w-5 h-5" />
            </button>
          </div>
          <form
          ...
          >
            ...
            <input className={inputClass} placeholder="Designation" value={form.designation} onChange={e => setForm({ ...form, designation: e.target.value })} required />
            ...
            <div className="flex justify-end space-x-3 mt-4">
              <button type="button" onClick={onClose} className="px-4 py-2 rounded bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-white">Cancel</button>
