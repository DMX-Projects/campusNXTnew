...
//   const categoryFees = {
//   General: 1000, // Base fee
//   SC: 500,       // 50% reduction
//   ST: 500,       // 50% reduction
//   OBC: 750,      // 25% reduction
//   EWS: 600,      // 40% reduction
// };
...
//   };
//   useEffect(() => {
//   const categoryFee = categoryFees[formData.Category as keyof typeof categoryFees] || categoryFees.General;
//   setFormData(prev => ({ ...prev, Fee: categoryFee }));
// }, [formData.Category]);
...
//               </div>
//               <div>
//                 <label className={`block text-sm font-medium ${currentTheme.text} mb-2`}>Fee</label>
...
//     value={formData.Fee}
//     readOnly
//     className={`w-full px-3 py-2 rounded-lg border ${currentTheme.input} bg-gray-100 transition-colors`}
//   />
// </div> */}
