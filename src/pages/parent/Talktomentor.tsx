...
// // Static data to simulate mentor details without an API
// const mentorData = {
//   name: 'Dr. Anjali Sharma',
//   designation: 'Professor, Department of Computer Science',
//   image: 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fixian.in%2Fblog%2F10-features-all-college-management-software-needs-to-have%2F&psig=AOvVaw0SMk9adoBfTZ8cBE0odDP0&ust=1756804276491000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCLDwkLuct48DFQAAAAAdAAAAABAE', // Placeholder or static image URL
//   email: 'anjali.sharma@erpcollege.edu',
//   phone: '+91-9876543210',
//   about: 'Dr. Anjali Sharma serves as an academic mentor, guiding students on their academic and career paths. She is available to discuss performance, course selection, and professional development.',
// };

// const TalkToMentor = () => {
//   // Destructure the mentorData object for cleaner and more readable code
//   const { name, designation, image, email, phone, about } = mentorData;

//   return (
//     <div className="p-6 bg-gray-100 min-h-screen font-sans">
//       <h1 className="text-3xl font-bold text-center mb-8 text-indigo-800">Talk to Mentor 🤝</h1>
      
//       <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden md:flex">
        
//         {/* Mentor Profile Picture and Title */}
//         <div className="md:flex-shrink-0 p-6 md:p-8 flex flex-col items-center justify-center">
//           <img className="h-48 w-48 rounded-full object-cover mb-4 shadow-lg border-4 border-white" src={image} alt={`Profile of ${name}`} />
//           <div className="text-center">
//             <h2 className="uppercase tracking-wide text-sm text-indigo-500 font-semibold">{designation}</h2>
//             <p className="block mt-1 text-2xl leading-tight font-medium text-black">{name}</p>
//           </div>
//         </div>

//         {/* Mentor Details and Actions */}
//         <div className="p-8 flex-grow">
//           <h3 className="text-2xl font-semibold text-gray-800 mb-4 border-b-2 pb-2">Contact Information</h3>
//           <div className="mb-6 space-y-3">
//             {/* Email Contact */}
//             <div className="flex items-center text-gray-600">
//               <svg className="h-6 w-6 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-17 4v5a2 2 0 002 2h12a2 2 0 002-2v-5"></path></svg>
//               <a href={`mailto:${email}`} className="text-lg hover:underline transition-colors duration-200">{email}</a>
//             </div>
            
//             {/* Phone Contact */}
//             <div className="flex items-center text-gray-600">
//               <svg className="h-6 w-6 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.158l-2.296 1.148a11.025 11.025 0 005.42 5.42l1.148-2.296a1 1 0 011.158-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
//               <a href={`tel:${phone}`} className="text-lg hover:underline transition-colors duration-200">{phone}</a>
//             </div>
//           </div>
          
//           <h3 className="text-2xl font-semibold text-gray-800 mb-4 mt-6 border-b-2 pb-2">About the Mentor</h3>
//           <p className="text-gray-700 text-base leading-relaxed">{about}</p>
          
//           <div className="mt-8 flex justify-end">
//             <button className="px-8 py-3 bg-indigo-600 text-white font-medium rounded-lg shadow-md hover:bg-indigo-700 transition-colors duration-200 transform hover:scale-105">
//               Send a Message
//             </button>
//           </div>
//         </div>
