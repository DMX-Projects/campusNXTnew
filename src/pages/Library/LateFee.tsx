...
export default function LateFee() {
  ...
  // Add local state for fines if you need to update fine status here (optional)
  ...
  // Handler for Mark Paid button click
  const handleMarkPaid = (fineId: string) => {
    if (window.confirm('Are you sure you want to mark this fine as Paid?')) {
      ...
      // Implement logic to update fine status here (e.g. update state or call backend)
    }
  };

  // Handler for Waive button click
  const handleWaive = (fineId: string) => {
    if (window.confirm('Are you sure you want to waive this fine?')) {
      ...
      // Implement logic to update fine status here
    }
  };
